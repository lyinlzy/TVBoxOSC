    ...
    steps:
      ...
      - name: Release Apk Sign
        ...
        run: |
          ...
          sed -i '$a\RELEASE_KEY_ALIAS=${{ KEY_ALIAS }}'            ./gradle.properties
          sed -i '$a\RELEASE_STORE_PASSWORD=${{ STORE_PASSWORD }}'       ./gradle.properties
          sed -i '$a\RELEASE_KEY_PASSWORD=${{ KEY_PASSWORD }}'         ./gradle.properties
